...
输出：一份 **15 节结构化的需求分析报告**，可直接用于 PRD 撰写、Sprint 规划或技术设计。
...
| 4 | **需求表达** | 精确的、可测试的语言 — 杜绝模糊词 + 按需求类型追加专项章节 |
| 5 | **质量检查** | 八维度审计 + 常见错误清单 |
| 6 | **弹性设计** | 变更类型 → 架构应对策略 |
...
输出遵循固定的 15 节模板。无需纠结文档结构 — AI 处理格式，团队审核内容。原本需要 2 天会议的分析，变成 10 分钟的 AI 对话。
